  ...
  return (
    <div className="flex h-screen">
      <div className="bg-white w-1/3 flex flex-col">
        ...
        <div className="justify-center p-2 text-center flex items-center">
          <span className="mr-2 text-gray-600 text-sm flex items-center">
            <svg
          ...
          <button
            onClick={logout}
            className="border rounded-sm text-sm py-1 px-2 bg-blue-100 text-gray-500"
          >
            logout
          </button>
        </div>
